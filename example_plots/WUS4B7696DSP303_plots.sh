...
python3 lat_kiops_plot.py -t "Latency and KIOPS of ${modelname} lbaf2" \
    ...
    -q 128 \
    -b 4096 4096
python3 lat_kiops_plot.py -t "Latency and KIOPS of ${modelname} lbaf0 (log10)" \
    -l 'spdk' 'io_uring' \
    -m $model $model \
    -f lbaf0 lbaf0 \
    -e spdk io_uring \
    ...
    -q 512 \
    -b 4096 4096
python3 lat_kiops_plot.py -t "Latency and KIOPS of ${modelname} lbaf0" \
    -l 'spdk' 'io_uring' \
    -m ${model} ${model} \
    -f lbaf0 lbaf0 \
    -e spdk io_uring \
...
python3 bs_kiops_plot.py -t "KIOPS of ${modelname} (QD=1)" \
    ...
    --upper_limit_y=120 \
    -q 1 1 1 1
python3 bs_kiops_plot.py -t "KIOPS of ${modelname} lbaf2 (QD=1)" \
    -l 'spdk' 'io_uring' \
    -m ${model} ${model} \
    -f lbaf3 lbaf3 \
    -e spdk io_uring \
    ...
    --upper_limit_y=350 \
    -q 1 1
python3 bs_kiops_plot.py -t "KIOPS of ${modelname} lbaf0 (QD=1)" \
    -l 'spdk' 'io_uring' \
    -m ${model} ${model} \
    -f lbaf0 lbaf0 \
    -e spdk io_uring \
...
python3 qd_kiops_plot.py -t "KIOPS of ${modelname} (bs=4096)" \
    -l 'spdk lbaf0' 'io_uring lbaf0' 'spdk lbaf3' 'io_uring lbaf3' \
    -m ${model} ${model} ${model} ${model} \
    -f lbaf0 lbaf0 lbaf3 lbaf3 \
    -e spdk io_uring spdk io_uring \
...
python3 qd_kiops_plot.py -t "KIOPS of ${modelname} (bs=4096) lbaf0" \
    -l 'spdk' 'io_uring' \
    -m ${model} ${model} \
    -f lbaf0 lbaf0 \
    -e spdk io_uring \
    ...
    --upper_limit_y=350 \
    -b 4096 4096
python3 qd_kiops_plot.py -t "KIOPS of ${modelname} (bs=4096) lbaf3" \
    -l 'spdk' 'io_uring' \
    -m ${model} ${model} \
    -f lbaf3 lbaf3 \
    -e spdk io_uring \
